...
import upvote from '../../assessts/sort-up-solid.svg'
import downvote from '../../assessts/sort-down-solid.svg' 
...
const User = useSelector((state) => (state.currentReducer))
                  ...
                  questionsList.data.filter(question => question._id === id).map(question => (
                      <div key={question._id}>
...

                          {
                              ...
                              :
                              "No answer provided be the first"
                          }
